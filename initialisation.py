...
planete1 = Planet(masse_terre,rayon_terre,0,0,-10000,20000)
planete2 = Planet(masse_terre,rayon_terre,3000*10**3,3,-30000,20000)
...
planete1 = Planet(masse_terre,rayon_terre,3000*10**3,2000*10**3,-8000,0)
