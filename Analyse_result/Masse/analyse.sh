...
do
    ...
    echo "$nbr_try masse de la Terre" >> analyse_masse2.txt


    #1) Trouver les infos désirées
    #Numéro des lignes
    let "ligne_interet=$line_number+8"

    #touver les lignes
    head -n $ligne_interet $File_name | tail -n 1 >> analyse_masse2.txt

    echo " " >> analyse_masse2.txt
